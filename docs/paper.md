...
draws on critical-thinking/reliance work [2].
...
assistant?). Segments roll up to an interpretive label — reflective, cautious,
...
Problem Solving.* Learning at Scale (L@S) 2026 (Best Paper). arXiv:2602.16251.

[2] Hou et al. *The role of critical thinking on undergraduates' reliance behaviours
on generative AI in problem-solving.* British Journal of Educational Technology,
2025.

[3] *GradeHITL: LLM-based Automated Grading with Human-in-the-Loop.* arXiv:2504.05239,
2025.

[4] *GradeOpt: An LLM-Powered Automatic Grading Framework with Human-Level Guidelines
Optimization.* EDM 2025.

[5] *CoTAL: Human-in-the-Loop Prompt Engineering for Generalizable Formative
Assessment Scoring.* arXiv:2504.02323, 2025.

[6] *Confusion-Aware Rubric Optimization for LLM-based Automated Grading.*
arXiv:2603.00451, 2026.

[7] H. Hashemi et al. *LLM-Rubric: A Multidimensional, Calibrated Approach to
Automated Evaluation of Natural Language Texts.* ACL 2024.

[8] *Harnessing large language models for multi-dimensional writing assessment:
Reliability and alignment with human judgments.* Heliyon, 2024.

[9] *Grading Scale Impact on LLM-as-a-Judge: Human–LLM Alignment Is Highest on a 0–5
Scale.* arXiv:2601.03444, 2026.

[10] *Are self-explanations from Large Language Models faithful?* arXiv:2401.07927,
2024.

[11] P. Manakul, A. Liusie, M. Gales. *SelfCheckGPT: Zero-Resource Black-Box
Hallucination Detection for Generative Large Language Models.* EMNLP 2023.

[12] *Overconfidence in LLM-as-a-Judge: Diagnosis and Confidence-Driven Solution.*
arXiv:2508.06225, 2025.

[13] S. Crossley et al. *Plagiarism Detection Using Keystroke Logs.* Educational
Data Mining (EDM) 2024.

[14] *Can theory-driven learning analytics dashboards enhance human–AI collaboration
in writing?* arXiv:2506.19364, 2025.

[15] *A Metacognitive Blind Spot: Student Comprehension, AI Reliance, and the
Conceptual Difficulty Gap.* Education Sciences, 2025.

[16] *AI Assistance Reduces Persistence and Hurts Independent Performance.*
arXiv:2604.04721, 2026.

[17] *To Rely or Not to Rely? Evaluating Interventions for Appropriate Reliance on
LLMs.* CHI 2025. arXiv:2412.15584.

[18] R. Mislevy, L. Steinberg, R. Almond. *On the Structure of Educational
Assessment* (Evidence-Centered Design). Measurement: Interdisciplinary Research and
Perspectives, 2003.

[19] Y. Attali, J. Burstein. *Automated Essay Scoring with e-rater V.2.* Journal of
Technology, Learning, and Assessment, 2006.

[20] *REL-A.I.: An Interaction-Centered Approach to Measuring Human–LM Reliance.*
NAACL 2025.

[21] *Four Types of LLM Reliance and Their Predictors Among Undergraduate Writers.*
arXiv:2606.28749, 2026.
